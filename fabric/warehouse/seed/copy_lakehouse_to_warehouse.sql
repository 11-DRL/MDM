...
-- {{SCHEMA_SILVER}}
TRUNCATE TABLE {{SCHEMA_SILVER}}.hub_location;
INSERT INTO {{SCHEMA_SILVER}}.hub_location (location_hk, business_key, load_date, record_source)
SELECT location_hk, business_key, load_date, record_source FROM lh_mdm.{{SCHEMA_SILVER}}.hub_location;

TRUNCATE TABLE {{SCHEMA_SILVER}}.sat_location_lightspeed;
INSERT INTO {{SCHEMA_SILVER}}.sat_location_lightspeed
...
FROM lh_mdm.{{SCHEMA_SILVER}}.sat_location_lightspeed;

TRUNCATE TABLE {{SCHEMA_SILVER}}.sat_location_yext;
INSERT INTO {{SCHEMA_SILVER}}.sat_location_yext
...
FROM lh_mdm.{{SCHEMA_SILVER}}.sat_location_yext;

TRUNCATE TABLE {{SCHEMA_SILVER}}.sat_location_mcwin;
INSERT INTO {{SCHEMA_SILVER}}.sat_location_mcwin
...
FROM lh_mdm.{{SCHEMA_SILVER}}.sat_location_mcwin;

TRUNCATE TABLE {{SCHEMA_SILVER}}.sat_location_gopos;
INSERT INTO {{SCHEMA_SILVER}}.sat_location_gopos
...
FROM lh_mdm.{{SCHEMA_SILVER}}.sat_location_gopos;

TRUNCATE TABLE {{SCHEMA_SILVER}}.pit_location;
INSERT INTO {{SCHEMA_SILVER}}.pit_location (location_hk, snapshot_date, sat_lightspeed_ld, sat_yext_ld, sat_mcwin_ld, sat_gopos_ld)
SELECT location_hk, snapshot_date, sat_lightspeed_ld, sat_yext_ld, sat_mcwin_ld, sat_gopos_ld FROM lh_mdm.{{SCHEMA_SILVER}}.pit_location;

TRUNCATE TABLE {{SCHEMA_SILVER}}.bv_location_match_candidates;
INSERT INTO {{SCHEMA_SILVER}}.bv_location_match_candidates
...
FROM lh_mdm.{{SCHEMA_SILVER}}.bv_location_match_candidates;

TRUNCATE TABLE {{SCHEMA_SILVER}}.bv_location_key_resolution;
INSERT INTO {{SCHEMA_SILVER}}.bv_location_key_resolution
...
FROM lh_mdm.{{SCHEMA_SILVER}}.bv_location_key_resolution;

TRUNCATE TABLE {{SCHEMA_SILVER}}.stewardship_log;
INSERT INTO {{SCHEMA_SILVER}}.stewardship_log
...
FROM lh_mdm.{{SCHEMA_SILVER}}.stewardship_log;

-- {{SCHEMA_GOLD}}
TRUNCATE TABLE {{SCHEMA_GOLD}}.dim_location;
INSERT INTO {{SCHEMA_GOLD}}.dim_location
...
FROM lh_mdm.{{SCHEMA_GOLD}}.dim_location;

TRUNCATE TABLE {{SCHEMA_GOLD}}.dim_location_quality;
INSERT INTO {{SCHEMA_GOLD}}.dim_location_quality
...
FROM lh_mdm.{{SCHEMA_GOLD}}.dim_location_quality;
